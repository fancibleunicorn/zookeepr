...
const handleAnimalFormSubmit = event => {
  ...
  // in order to POST submited animal info
  fetch('/api/animals', {
    //you have to tell it it's a POST request (GET is default)
    method: 'POST',
    // tells what type of data we're looking to send and then provide the data
    headers: {
